...
class CompletionRequest(BaseModel):
    ...
    max_tokens: Optional[int] = Field(
        None, 
        description="Max tokens for standard models. Ignored for reasoning models."
    )
    max_completion_tokens: Optional[int] = Field(
        None,
        description="Max completion tokens for reasoning models. Takes precedence if set."
    )
    ...
    top_p: Optional[float] = Field(
        ...
        ge=0.0, 
        le=1.0,
        description="Nucleus sampling. Not supported by reasoning models."
    )
    ...
    presence_penalty: Optional[float] = Field(
        ...
        ge=-2.0,
        le=2.0,
        description="Presence penalty. Not supported by reasoning models."
    )
    frequency_penalty: Optional[float] = Field(
        None,
        ge=-2.0,
        le=2.0,
        description="Frequency penalty. Not supported by reasoning models."
    )
    ...
    data_sources: Optional[List[Dict[str, Any]]] = Field(
        None,
        description="Azure OpenAI data sources for RAG scenarios"
    )
